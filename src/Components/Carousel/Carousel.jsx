            ...
            <div className="carousel-item-row">
              <div className="hero">
                <div className="texto-ofertas">
                  ...
                  <h1 className="titulo">
                    Queima de stoque Nike <img src={fire} alt="fire" />
                  </h1>
                  <p className="texto">
                    Consequat culpa exercitation mollit nisi excepteur do do
                    tempor laboris eiusmod irure consectetur.
                  </p>
                  <div className="button-link-home btn-carousel-home">
                    <Link to="/ProductList">Ver Ofertas</Link>
                  </div>
                </div>
              </div>
